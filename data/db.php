...
$datas[] = "INSERT INTO `ims_uni_account` (`uniacid`, `groupid`, `name`, `description`) VALUES(1, -1, '微动力团队', '一个朝气蓬勃的团队');";
...
(1, 1, '微动力团队', 1, '', 'a:2:{s:8:"template";s:7:"default";s:12:"enablemodule";a:0:{}}', 1);
EOF;
$datas[] = "INSERT INTO `ims_site_styles` (`id`, `uniacid`, `templateid`, `name`) VALUES(1, 1, 1, '微站默认模板_gC5C');";
$datas[] = "INSERT INTO `ims_site_templates` (`id`, `name`, `title`, `description`, `author`, `url`, `type`) VALUES(1, 'default', '微站默认模板', '由微动力提供默认微站模板套系', '微动力团队', 'http://wdlcms.com', 1);";
...
EOF;
$datas[] = <<<EOF
INSERT INTO `ims_core_settings` (`key`, `value`) VALUES ('copyright', 'a:17:{s:8:"sitename";s:24:"微动力微信管理系统";s:3:"url";s:17:"http://www.wdlcms.com";s:8:"statcode";s:0:"";s:10:"footerleft";s:17:"powered by wdlcms.com";s:11:"footerright";s:0:"";s:5:"flogo";s:0:"";s:5:"blogo";s:0:"";s:8:"baidumap";a:2:{s:3:"lng";s:10:"114.060055";s:3:"lat";s:9:"22.529554";}s:7:"company";s:39:"深圳市零壹贰科技有限公司";s:7:"address";s:68:"深圳市龙华新区民治大道展滔科技大厦A栋13A03";s:6:"person";s:9:"微动力";s:5:"phone";s:11:"15800008888";s:2:"qq";s:9:"800083075";s:5:"email";s:0:"";s:8:"keywords";s:82:"微动力,微信,微信公众平台,公众平台二次开发,公众平台开源软件";s:11:"description";s:82:"微动力,微信,微信公众平台,公众平台二次开发,公众平台开源软件";s:12:"showhomepage";i:1;}');
EOF;
$datas[] = <<<EOF
INSERT INTO `ims_core_settings` (`key`, `value`) VALUES ('register', 'a:4:{s:4:"open";i:1;s:6:"verify";i:0;s:4:"code";i:1;s:7:"groupid";i:1;}');
EOF;
$datas[] = <<<EOF
INSERT INTO `ims_core_settings` (`key`, `value`) VALUES ('addons','a:2:{s:10:"addons_url";s:23:"http://addons.weizancms.com";s:5:"c_url";s:20:"http://www.wdlcms.com";}');
EOF;
...
('1','basic','system','基本文字回复','1.0','和您进行简单对话','一问一答得简单对话. 当访客的对话语句中包含指定关键字, 或对话语句完全等于特定关键字, 或符合某些特定的格式时. 系统自动应答设定好的回复内容.','Weizan Team','http://www.wdlcms.com/','0','','','1','1','0','0'),
('2','news','system','基本混合图文回复','1.0','为你提供生动的图文资讯','一问一答得简单对话, 但是回复内容包括图片文字等更生动的媒体内容. 当访客的对话语句中包含指定关键字, 或对话语句完全等于特定关键字, 或符合某些特定的格式时. 系统自动应答设定好的图文回复内容.','Weizan Team','http://www.wdlcms.com/','0','','','1','1','0','0'),
('3','music','system','基本音乐回复','1.0','提供语音、音乐等音频类回复','在回复规则中可选择具有语音、音乐等音频类的回复内容，并根据用户所设置的特定关键字精准的返回给粉丝，实现一问一答得简单对话。','Weizan Team','http://www.wdlcms.com/','0','','','1','1','0','0'),
('4','userapi','system','自定义接口回复','1.1','更方便的第三方接口设置','自定义接口又称第三方接口，可以让开发者更方便的接入微动力系统，高效的与微信公众平台进行对接整合。','Weizan Team','http://www.wdlcms.com/','0','','','1','1','0','0'),
('5','recharge','system','会员中心充值模块','1.0','提供会员充值功能','','Weizan Team','http://www.wdlcms.com/','0','','','0','1','0','0'),
('6','chats','system','发送客服消息','1.0','公众号可以在粉丝最后发送消息的48小时内无限制发送消息','','Weizan Team','http://www.wdlcms.com/','0','','','0','1','0','0'),
('7','voice','system','基本语音回复','1.0','提供语音回复','在回复规则中可选择具有语音的回复内容，并根据用户所设置的特定关键字精准的返回给粉丝语音。','Weizan Team','http://www.wdlcms.com/','0','','','1','1','0','0'),
('9','images','system','基本图片回复','1.0','提供图片回复','在回复规则中可选择具有图片的回复内容，并根据用户所设置的特定关键字精准的返回给粉丝图片。','Weizan Team','http://www.wdlcms.com/','0','','','1','1','0','0'),
('10','video','system','基本视频回复','1.0','提供视频回复','在回复规则中可选择具有视频的回复内容，并根据用户所设置的特定关键字精准的返回给粉丝视频。','Weizan Team','http://www.wdlcms.com/','0','','','1','1','0','0');

";

$datas[] = <<<EOF
insert into `ims_modules`(`mid`,`name`,`type`,`title`,`version`,`ability`,`description`,`author`,`url`,`settings`,`subscribes`,`handles`,`isrulefields`,`issystem`,`issolution`,`target`) values
('8','custom','system','多客服转接','1.0.0','用来接入腾讯的多客服系统','','Weizan Team','http://bbs.wdlcms.com','0','a:0:{}','a:6:{i:0;s:5:"image";i:1;s:5:"voice";i:2;s:5:"video";i:3;s:8:"location";i:4;s:4:"link";i:5;s:4:"text";}','1','1','0','0');
EOF;
...
(2, 1, 1, 8, 'site', '', '微动力团队入口设置', '', '', './index.php?c=home&i=1&t=1');
EOF;
...
('111', '0', '会员套餐', 'members', '', 'fa fa-cubes', '', '0', 'url', '1', '1', ''),
...
('116', '115', '会员消费', 'members', './index.php?c=members&a=record&', '', '', '0', 'url', '1', '1', 'members_record'),
('117', '115', '套餐配置', 'members', './index.php?c=members&a=configs&', '', '', '0', 'url', '1', '1', 'members_configs'),
('118', '115', '功能配置', 'members', './index.php?c=members&a=mpayset&', '', '', '0', 'url', '1', '1', 'members_mpayset'),
...
('138', '111', '功能购买', 'members', '', '', '', '0', 'permission', '1', '1', ''),
('139', '138', '模块列表', 'members', './index.php?c=members&a=module&', '', '', '0', 'url', '1', '1', 'members_module'),
('140', '138', '记录查询', 'members', './index.php?c=members&a=mrecord&', '', '', '0', 'url', '1', '1', 'members_mrecord'),
('141', '138', '用户管理', 'members', './index.php?c=members&a=muser&', '', '', '0', 'url', '1', '1', 'members_muser');
...
(11, 'wxcard', 'system', '微信卡券回复', '1.0', '微信卡券回复', '微信卡券回复', 'Weizan', 'http://www.wdlcms.com/', 0, '', '', 1, 1, 0, 0, ''),
(12, 'paycenter', 'system', '收银台', '1.0', '收银台', '收银台', 'Weizan', 'http://www.wdlcms.com/', 0, '', '', 1, 1, 0, 0, '');
