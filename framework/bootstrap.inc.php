...
if(!file_exists($configfile)) {
	if(file_exists(IA_ROOT . '/install.php')) {
		...
		echo "&nbsp;&nbsp;<a href='http://www.012wz.com' style='font-size:12px' target='_blank'>Power by WEIZAN &nbsp;V8 &nbsp;微动力公众平台自助开源引擎</a> &nbsp; &nbsp;<a href='http://wpa.b.qq.com/cgi/wpa.php?ln=1&key=XzgwMDA4MzA3NV8zMDk2MDdfODAwMDgzMDc1XzJf' style='font-size:12px' target='_blank'>正版购买咨询</a>";
		exit();
	} else {
		header('Content-Type: text/html; charset=utf-8');
